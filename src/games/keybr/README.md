...
Core modules, UI, and the application entry point live directly in this directory.
...
The catalog contains 100 English books plus the existing French, German, and Spanish editions. The 97 added English works are pinned to Project Gutenberg ebook IDs in `content/books/catalog.ts`; the importer strips Gutenberg wrappers and rejects suspiciously truncated results.
